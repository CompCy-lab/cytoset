...
##### prepare meta data #####
setwd("~/Documents/proj/CytoSet/Data/AML")
...
train_data = select(train_data, -`Kappa-FITC`, -`Lambda-PE`, -`7AAD`, -`FL1-Log`, -`FL2-Log`, -`FL4-Log`, -`FL5-Log`)

x_train <- model.matrix(~., train_data[, 1:33])
...
test_data = select(test_data, -`Kappa-FITC`, -`Lambda-PE`, -`7AAD`, -`FL1-Log`, -`FL2-Log`, -`FL4-Log`, -`FL5-Log`)
x_test <- model.matrix(~., test_data[, 1:33])
...
cat("ACC for predicting AML = ", acc, "\n")
cat("AUC for predicting AML = ", auc, "\n")
